...
import com.ctgu.adapter.SendTransactionsAdapter;
...
public class SendTransactions extends BaseActivity implements LoadingListener {
	public int DataSizePerPage = 10;
	SendTransactionsAdapter adapter;
	ListView listView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tranionsend);
		...
		adapter = new SendTransactionsAdapter(this, SendTransactions.this);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toast(adapter.getItem(position).toString());
	...
	public void doLoadMore() {
		...
		AsyncHttp.Post(C.api.getSendTranion, params, new AsyncHttpResponseHandler() {
