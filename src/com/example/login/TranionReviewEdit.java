...
public class TranionReviewEdit extends BaseUiAuth {
	EditText et_discuss;
	private String id;
	...
	class on_Click implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.bt_discuss:
				...
				pd.show();
				taskPool_ctguHelp.addTask(C.task.setReview, C.api.setTranionReview, taskArgs, new BaseTask() {
	...
	private void createExpressionDialog() {
		builder = new AlertDialog.Builder(TranionReviewEdit.this);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				ImageSpan imageSpan = new ImageSpan(TranionReviewEdit.this, resId, 10);
				String str = null;
				if (arg2 < 10) {
					str = "f00" + arg2;
				} else if (arg2 < 100) {
