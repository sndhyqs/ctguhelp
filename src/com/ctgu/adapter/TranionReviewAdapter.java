...
import com.example.login.TranionConView;
...
public class TranionReviewAdapter extends BaseAdapter {
	private ArrayList<Review> reviewArr;
	private Context context;
	private int index;
	private TranionConView c;

	public TranionReviewAdapter(Context context, TranionConView c) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TVreview.setOnClickListener(new on_Click());
		return v;
	}
